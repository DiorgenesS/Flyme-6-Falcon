...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt BluetoothMidiService com.qualcomm.location com.qualcomm.services.location HTMLViewer KeyChain PrintSpooler qcrilmsgtunnel Stk telresources TimeService UserDictionaryProvider \
...
#-----------------------------------------------------------------------------
board_modify_apps := Settings SystemUI TeleService
